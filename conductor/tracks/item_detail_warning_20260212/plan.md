...
- [x] Task: Reproduce the warning in the development environment
    - [x] Run `make dev` and confirm the warning appears in the browser console when using 'j'/'k' in `ItemDetailModal`.
- [x] Task: Identify the specific code triggering the warning
...
- [x] Task: Conductor - User Manual Verification 'Phase 1: Reproduction and Investigation' (Protocol in workflow.md)
...
- [x] Task: Wrap offending code in appropriate reactive context
...
- [x] Task: Verify the fix in development
