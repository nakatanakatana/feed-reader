...
## Phase 2: Implementation and Verification [checkpoint: 0ca11ff]
- [x] Task: Update `frontend/src/components/FeedList.tsx` to display "Soon" when `nextFetch` is in the past. [0ebad1a]
- [x] Task: Verify that the failing test now passes and all other `FeedList` tests pass. [0ebad1a]
- [x] Task: Conductor - User Manual Verification 'Phase 2' (Protocol in workflow.md) [0ca11ff]
