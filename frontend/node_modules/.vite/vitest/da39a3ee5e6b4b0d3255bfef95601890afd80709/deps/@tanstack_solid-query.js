import {
  ...
  reconcile,
  unwrap
} from "./chunk-LMPMWS4F.js";
import {
  isServer
} from "./chunk-4APSJKIR.js";
import {
  batch,
  createComponent,
  createComputed,
...
var QueryObserver = class extends Subscribable {
  ...
  #updateStaleTimeout() {
    ...
    if (isServer2 || this.#currentResult.isStale || !isValidTimeout(staleTime)) {
      return;
    }
  ...
  #updateRefetchInterval(nextInterval) {
    ...
    if (isServer2 || resolveEnabled(this.options.enabled, this.#currentQuery) === false || !isValidTimeout(this.#currentRefetchInterval) || this.#currentRefetchInterval === 0) {
      return;
    }
