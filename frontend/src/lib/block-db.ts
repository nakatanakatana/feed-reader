...
export const urlParsingRulesOptions = queryCollectionOptions({
  id: "url-rules",
  queryClient,
  queryKey: ["url-rules"],
  gcTime: 5 * 1000,
...
export const urlParsingRules = createRoot(() =>
  createCollection(urlParsingRulesOptions),
);

export const itemBlockRulesOptions = queryCollectionOptions({
  id: "block-rules",
  queryClient,
...
export const itemBlockRules = createRoot(() =>
  createCollection(itemBlockRulesOptions),
);
