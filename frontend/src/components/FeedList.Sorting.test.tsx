    ...
    worker.use(
      http.post("*/feed.v1.FeedService/ListFeeds", () => {
        const msg = create(ListFeedsResponseSchema, {
          feeds: [
            create(ListFeedSchema, { id: "1", title: "B Feed", url: "url1", tags: [] }),
            create(ListFeedSchema, { id: "2", title: "A Feed", url: "url2", tags: [] }),
            create(ListFeedSchema, { id: "3", title: "C Feed", url: "url3", tags: [] }),
          ]
        });
