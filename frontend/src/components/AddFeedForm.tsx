...
export function AddFeedForm() {
  ...
  return (
    <form onSubmit={handleSubmit} class={flex({ gap: '2', alignItems: 'flex-start', flexWrap: 'wrap' })}>
      ...
      {mutation.isError && <p class={css({ color: 'red.500', fontSize: 'sm', width: 'full' })}>Error: {mutation.error?.message}</p>}
    </form>
  );
}
