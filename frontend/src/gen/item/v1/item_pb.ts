...
export const file_item_v1_item: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp]);

/**
 * @generated from message item.v1.ListItemReadsRequest
 */
export type ListItemReadsRequest = Message<"item.v1.ListItemReadsRequest"> & {
  /**
...
/**
 * Describes the message item.v1.ListItemReadsRequest.
 * Use `create(ListItemReadsRequestSchema)` to create a new message.
 */
export const ListItemReadsRequestSchema: GenMessage<ListItemReadsRequest> = /*@__PURE__*/
...
/**
 * @generated from message item.v1.ListItemReadsResponse
 */
export type ListItemReadsResponse = Message<"item.v1.ListItemReadsResponse"> & {
  /**
...
/**
 * Describes the message item.v1.ListItemReadsResponse.
 * Use `create(ListItemReadsResponseSchema)` to create a new message.
 */
export const ListItemReadsResponseSchema: GenMessage<ListItemReadsResponse> = /*@__PURE__*/
...
export const ItemService: GenService<{
  ...
  /**
   * @generated from rpc item.v1.ItemService.ListItemReads
   */
  listItemReads: {
    methodKind: "unary";
    input: typeof ListItemReadsRequestSchema;
    output: typeof ListItemReadsResponseSchema;
  },
}> = /*@__PURE__*/
