...
export const file_item_v1_item: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp]);

/**
 * @generated from message item.v1.Author
 */
export type Author = Message<"item.v1.Author"> & {
  /**
...
/**
 * Describes the message item.v1.Author.
...
export type Item = Message<"item.v1.Item"> & {
  ...
  /**
   * @generated from field: repeated item.v1.Author authors = 14;
   */
  authors: Author[];
};
