...
type ListItemReadsRequest struct {
...
func (x *ListItemReadsRequest) Reset() {
	*x = ListItemReadsRequest{}
	mi := &file_item_v1_item_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListItemReadsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListItemReadsRequest) ProtoMessage() {}

func (x *ListItemReadsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_item_v1_item_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ListItemReadsRequest.ProtoReflect.Descriptor instead.
func (*ListItemReadsRequest) Descriptor() ([]byte, []int) {
	return file_item_v1_item_proto_rawDescGZIP(), []int{0}
}

func (x *ListItemReadsRequest) GetSince() *timestamppb.Timestamp {
	if x != nil {
		return x.Since
	}
	return nil
...
func (x *ListItemReadsRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *ListItemReadsRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type ListItemReadsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListItemReadsResponse) Reset() {
	*x = ListItemReadsResponse{}
	mi := &file_item_v1_item_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListItemReadsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListItemReadsResponse) ProtoMessage() {}

func (x *ListItemReadsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_item_v1_item_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListItemReadsResponse.ProtoReflect.Descriptor instead.
func (*ListItemReadsResponse) Descriptor() ([]byte, []int) {
	return file_item_v1_item_proto_rawDescGZIP(), []int{2}
}

func (x *ListItemReadsResponse) GetItemReads() []*ItemRead {
	if x != nil {
		return x.ItemReads
	}
	return nil
...
const file_item_v1_item_proto_rawDesc = "" +
	"\n" +
	"\x12item/v1/item.proto\x12\aitem.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x85\x01\n" +
	"\x14ListItemReadsRequest\x125\n" +
	"\x05since\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\x05since\x88\x01\x01\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\x03 \x01(\x05R\x06offsetB\b\n" +
	"\x06_since\"w\n" +
	"\bItemRead\x12\x17\n" +
	...
	"\x05rules\x18\x01 \x03(\v2\x16.item.v1.ItemBlockRuleR\x05rules2\xe6\a\n" +
	"\vItemService\x12A\n" +
	...
	"\x12ListItemBlockRules\x12\".item.v1.ListItemBlockRulesRequest\x1a#.item.v1.ListItemBlockRulesResponse\"\x03\x90\x02\x01\x12S\n" +
	"\rListItemReads\x12\x1d.item.v1.ListItemReadsRequest\x1a\x1e.item.v1.ListItemReadsResponse\"\x03\x90\x02\x01B=Z;github.com/nakatanakatana/feed-reader/gen/go/item/v1;itemv1b\x06proto3"
...
var file_item_v1_item_proto_goTypes = []any{
	(*ListItemReadsRequest)(nil),          // 0: item.v1.ListItemReadsRequest
	(*ItemRead)(nil),                      // 1: item.v1.ItemRead
	(*ListItemReadsResponse)(nil),         // 2: item.v1.ListItemReadsResponse
...
var file_item_v1_item_proto_depIdxs = []int32{
	29, // 0: item.v1.ListItemReadsRequest.since:type_name -> google.protobuf.Timestamp
	29, // 1: item.v1.ItemRead.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 2: item.v1.ListItemReadsResponse.item_reads:type_name -> item.v1.ItemRead
	...
	0,  // 21: item.v1.ItemService.ListItemReads:input_type -> item.v1.ListItemReadsRequest
	...
	2,  // 32: item.v1.ItemService.ListItemReads:output_type -> item.v1.ListItemReadsResponse
