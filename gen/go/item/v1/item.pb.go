...
type Item struct {
	...
	Authors       []*Author              `protobuf:"bytes,14,rep,name=authors,proto3" json:"authors,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_item_v1_item_proto_rawDesc = "" +
	"\n" +
	"\x12item/v1/item.proto\x12\aitem.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"`\n" +
	"\x06Author\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x19\n" +
	"\x05email\x18\x02 \x01(\tH\x00R\x05email\x88\x01\x01\x12\x15\n" +
	"\x03uri\x18\x03 \x01(\tH\x01R\x03uri\x88\x01\x01B\b\n" +
	"\x06_emailB\x06\n" +
	"\x04_uri\"\xdc\x02\n" +
	"\x04Item\x12\x0e\n" +
	...
	"\aauthors\x18\x0e \x03(\v2\x0f.item.v1.AuthorR\aauthorsJ\x04\b\t\x10\n" +
	"\"\xd8\x01\n" +
	"\bListItem\x12\x0e\n" +
...
var file_item_v1_item_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_item_v1_item_proto_goTypes = []any{
	(*Author)(nil),                   // 0: item.v1.Author
	...
	(*ListItemFeedsRequest)(nil),     // 9: item.v1.ListItemFeedsRequest
	(*ItemFeed)(nil),                 // 10: item.v1.ItemFeed
	(*ListItemFeedsResponse)(nil),    // 11: item.v1.ListItemFeedsResponse
	(*timestamppb.Timestamp)(nil),    // 12: google.protobuf.Timestamp
}
var file_item_v1_item_proto_depIdxs = []int32{
	0,  // 0: item.v1.Item.authors:type_name -> item.v1.Author
	1,  // 1: item.v1.GetItemResponse.item:type_name -> item.v1.Item
	12, // 2: item.v1.ListItemsRequest.since:type_name -> google.protobuf.Timestamp
	2,  // 3: item.v1.ListItemsResponse.items:type_name -> item.v1.ListItem
	10, // 4: item.v1.ListItemFeedsResponse.feeds:type_name -> item.v1.ItemFeed
	...
	7,  // 7: item.v1.ItemService.UpdateItemStatus:input_type -> item.v1.UpdateItemStatusRequest
	9,  // 8: item.v1.ItemService.ListItemFeeds:input_type -> item.v1.ListItemFeedsRequest
	4,  // 9: item.v1.ItemService.GetItem:output_type -> item.v1.GetItemResponse
	6,  // 10: item.v1.ItemService.ListItems:output_type -> item.v1.ListItemsResponse
	8,  // 11: item.v1.ItemService.UpdateItemStatus:output_type -> item.v1.UpdateItemStatusResponse
	11, // 12: item.v1.ItemService.ListItemFeeds:output_type -> item.v1.ListItemFeedsResponse
...
func file_item_v1_item_proto_init() {
	...
	file_item_v1_item_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
